  ...
  <ControlButton
    ...
    sx={{
      ...
      '& svg': {
        width: '20px',
        height: '20px',
        stroke: iff(isActive && isRecording, '#ff4444', iff(isActive, '#64b5f6', '#e0e0e0')),
        strokeWidth: 2,
      ...
      '&:hover svg': {
        ...
        filter: isActive
          ? 'drop-shadow(0 2px 6px rgba(100, 181, 246, 0.3))'
      ...
      '& .MuiTypography-root': {
        ...
        letterSpacing: '0.2px',
        color: iff(isActive && isRecording, '#ff6b6b', iff(isActive, '#64b5f6', '#e0e0e0')),
        transition: 'all 0.2s ease',
        textAlign: 'center',
      },
