...
export const ENV = {
  ...
  COINROUTES_API_KEY: getEnvVar('VITE_COINROUTES_API_KEY', 'REACT_APP_COINROUTES_API_KEY'),
  SQUAWK_KEY: getEnvVar('VITE_SQUAWK_KEY', 'REACT_APP_Squawk_Key'),
  SQUAWK_VALUE: getEnvVar('VITE_SQUAWK_VALUE', 'REACT_APP_Squawk_Value'),
  TWITTER_CLIENT_ID: getEnvVar('VITE_TWITTER_CLIENT_ID', 'REACT_APP_TWITTER_CLIENT_ID'),
  ...
  GOOGLE_CLIENT_ID: getEnvVar('VITE_GOOGLE_CLIENT_ID', 'REACT_APP_GOOGLE_CLIENT_ID'),
  LINKEDIN_CLIENT_ID: getEnvVar('VITE_LINKEDIN_CLIENT_ID', 'REACT_APP_LINKEDIN_CLIENT_ID'),
  BOOK_CALL_SECRET: getEnvVar('VITE_BOOK_CALL_SECRET', 'REACT_APP_BOOK_CALL_SECRET'),
}
