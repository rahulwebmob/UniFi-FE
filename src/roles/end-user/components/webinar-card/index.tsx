    ...
    return (
      <Card
        ...
        sx={{
          ...
          flexDirection: 'row',
          borderRadius: '12px',
          boxShadow: (thm: Theme) => thm.shadows[1],
          cursor: 'pointer',
          transition: 'all 0.2s ease',
          overflow: 'hidden',
          backgroundColor: (thm: Theme) => thm.palette.background.paper,
          height: '150px',
          minWidth: '380px',
          width: '380px',
          flexShrink: 0,
          '&:hover': {
            boxShadow: (thm: Theme) => thm.shadows[4],
          },
        }}
      >
        <Box
        ...
        >
          <Box
            sx={{
              ...
              borderRadius: '8px',
              overflow: 'hidden',
              backgroundColor: (thm: Theme) => thm.palette.grey[100],
              position: 'relative',
            }}
          >
            <Box
            ...
            >
              <Avatar
                ...
                sx={{
                  width: 16,
                  height: 16,
                  backgroundColor: (thm: Theme) => thm.palette.primary.light,
                  fontSize: '0.6rem',
                }}
              >
              ...
              <Typography
                sx={{
                  fontSize: '0.7rem',
                  color: (thm: Theme) => thm.palette.text.secondary,
                }}
              >
  ...
  return (
    <Card
      ...
      sx={{
        ...
        position: 'relative',
        border: '1px solid',
        borderColor: (thm: Theme) => thm.palette.grey[200],
        '&:hover': {
          transform: 'translateY(-4px)',
          boxShadow: '0 12px 24px rgba(0,0,0,0.1)',
          borderColor: (thm: Theme) => thm.palette.primary.light,
        },
      }}
    >
      ...
      >
        <Box
          ...
          onError={(e) => {
            ;(e.target as HTMLImageElement).src = '/placeholder-webinar.jpg'
          }}
        />
          ...
          >
            ...
            <Typography
              sx={{
                fontSize: '0.7rem',
                fontWeight: 600,
                color: (thm: Theme) => thm.palette.text.primary,
                pr: 0.5,
              }}
            >
              {webinar.educatorDetail.firstName}{' '}
        ...
        {webinar.webinarScheduledObj?.join_date && locale && (
          <Box
            sx={{
              ...
              gap: 2,
              mb: 1.5,
              backgroundColor: (thm: Theme) => thm.palette.grey[50],
              borderRadius: '8px',
              p: 1,
            }}
          >
