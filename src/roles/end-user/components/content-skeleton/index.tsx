            ...
            >
              ...
              <Box sx={{ flex: 1, p: 2, display: 'flex', flexDirection: 'column' }}>
                ...
                <Box sx={{ display: 'flex', gap: 0.5, mb: 2 }}>
                  <Skeleton variant="rectangular" sx={{ width: 80, height: 24, borderRadius: '20px' }} />
                  <Skeleton variant="rectangular" sx={{ width: 60, height: 24, borderRadius: '20px' }} />
                </Box>
                <Box sx={{ flexGrow: 1 }} />
          ...
          >
            ...
            <Box sx={{ p: 2, flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Skeleton variant="rectangular" sx={{ width: 80, height: 32, borderRadius: '6px' }} />
              </Box>
            </Box>
          </Card>
        </Grid>
