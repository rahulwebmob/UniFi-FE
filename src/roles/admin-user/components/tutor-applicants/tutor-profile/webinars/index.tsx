...
import type { TutorWebinarDetail } from '../../../../../../services/admin.type'
...
const Webinars = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<TutorWebinarDetail>[]>(
    () => [
      {
      ...
      },
      {
        ...
        size: 120,
        Cell: ({ cell }) => {
          const enrolled = cell.getValue<number>()
          return (
        ...
        <>
          ...
          {webinarDetails && webinarDetails.count && (
            <Box sx={{ mt: 2, display: 'flex', justifyContent: 'center' }}>
              <PaginationComponent
                data={{ count: webinarDetails.count, totalPages: webinarDetails.totalPages || Math.ceil(webinarDetails.count / 10) }}
                page={page}
                setPage={setPage}
              />
            </Box>
